...
class Template
{
	...
	private function loadManifest()
	{
		...
		{
			show_error("Invalid theme. The file <b>manifest.json</b> is missing! Tplm ".APPPATH.$this->theme_path);
		}
	...
	private function handleNormalPage($content, $css, $js)
	{
		...
		$theme_data = array(
			...
			"full_theme_path" => $this->theme_url."application/".$this->theme_path,
